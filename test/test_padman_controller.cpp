...
#include "test_padman_controller.hpp"

using padman_controller::CMD_MY_ITFS;
using padman_controller::control_mode_type;
using padman_controller::STATE_MY_ITFS;

class PadmanControllerTest : public PadmanControllerFixture<TestablePadmanController>
{
};

TEST_F(PadmanControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, update_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(PadmanControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(PadmanControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(PadmanControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
